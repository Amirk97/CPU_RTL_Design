...
HD_PWD='E:/York/Digital_Design/VivadoProjects/datapath_standalone/datapath_standalone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Control_datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Control_datapath.tcl
